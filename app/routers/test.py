...
async def create_test_data(db: Session = Depends(get_db)):
    ...
    lesson1 = Lesson(
        ...
        finish_time=datetime.now() - timedelta(days=7) + timedelta(minutes=90),
    ...
    lesson2 = Lesson(
        ...
        finish_time=datetime.now() + timedelta(minutes=90),
    ...
    lesson4 = Lesson(
        ...
        finish_time=datetime.now() + timedelta(days=2) + timedelta(minutes=90),
    ...
    lesson5 = Lesson(
        ...
        finish_time=datetime.now() + timedelta(days=9) + timedelta(minutes=90),
        classroom_id=classroom4.id,
        group_id=group_beginner_hiphop.id,
        are_neighbours_allowed=True,
        is_confirmed=True
    ...
    lesson6 = Lesson(
        ...
        finish_time=datetime.now() + timedelta(days=1) + timedelta(minutes=60),
    ...
    lesson7 = Lesson(
        ...
        lesson_type_id=lesson_type_hiphop_indiv.id,
        start_time=datetime.now() + timedelta(days=9) + timedelta(minutes=15),
        finish_time=datetime.now() + timedelta(days=9) + timedelta(minutes=75),
        classroom_id=classroom4.id,
        are_neighbours_allowed=True,
        is_confirmed=True
    )
    ...
    lesson8 = Lesson(
        ...
        finish_time=datetime.now() + timedelta(days=11) + timedelta(minutes=60),
        are_neighbours_allowed=True,
        is_confirmed=False
    )
    db.add(lesson8)
    ...
    lesson9 = Lesson(
        ...
        lesson_type_id=lesson_type_hiphop_indiv.id,
        start_time=datetime.now() + timedelta(days=3) + timedelta(minutes=9),
        finish_time=datetime.now() + timedelta(days=3) + timedelta(minutes=69),
        are_neighbours_allowed=True,
        is_confirmed=False
    )
    db.add(lesson9)
    ...
    lesson10 = Lesson(
        name='Заявка на индивидуальное занятие по хип-хопу',
        lesson_type_id=lesson_type_hiphop_indiv.id,
        start_time=datetime.now() + timedelta(days=13),
        finish_time=datetime.now() + timedelta(days=13) + timedelta(minutes=50),
        are_neighbours_allowed=False,
        is_confirmed=False
    )
    db.add(lesson10)
